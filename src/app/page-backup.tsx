  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-blue-50 to-transparent rounded-full opacity-40"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-slate-50 to-transparent rounded-full opacity-30"></div>
      </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
                  ...
                  learning, surrogate models, and adversarial robustness. Active contributor to academia 
