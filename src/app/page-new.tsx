            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex gap-4">
                  <a href="mailto:spallab1@student.gsu.edu" className="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors">
                    Contact Me
                  </a>
                  <a href="https://scholar.google.com/citations?user=T7f9CiEAAAAJ" target="_blank" rel="noopener noreferrer" className="border border-slate-300 text-slate-700 px-6 py-3 rounded-lg font-medium hover:bg-slate-100 transition-colors">
                    Google Scholar
                  </a>
                </div>
              </div>
              <div className="relative">
                <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="text-center">
                      <div className="text-3xl font-bold text-blue-600 mb-1">AI/ML</div>
                      <div className="text-sm text-slate-600">Specialization</div>
                    </div>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-blue-600 mb-1">GSU</div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-slate-50 rounded-xl p-6 border border-slate-200 hover:border-blue-300 transition-colors">
                ...
                <p className="text-blue-600 font-medium mb-2">Georgia State University</p>
        ...
        <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a href="mailto:spallab1@student.gsu.edu" className="text-blue-400 hover:text-blue-300 transition-colors">
                spallab1@student.gsu.edu
              </a>
              <span className="hidden sm:inline text-slate-600">|</span>
              <a href="https://scholar.google.com/citations?user=T7f9CiEAAAAJ" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors">
